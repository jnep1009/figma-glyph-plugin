...
const Sketch = require('./node-sketch/Sketch');
...
(function(lib) {
    ...
    const Node = require('./node-sketch/Node');
    const classes = {
        style: require('./node-sketch/Style'),
        symbolInstance: require('./node-sketch/SymbolInstance'),
        MSJSONFileReference: require('./node-sketch/FileReference'),
        MSAttributedString: require('./node-sketch/Attributes')
    };
